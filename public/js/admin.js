$(document).ready(function() {
    ...
    //===== PAGINATE REQUEST =====//
    $('#_blueprint-table').on('click', '.paginate_button a', function(e) {
        e.preventDefault();
        ...
        $('#_blueprint-table').html('<div class="text-center"><img src="' + SITE_URL + 'images/ajax-loader.svg"/></div>');
        ajaxSubmit('admin/blueprint', 'POST', data, function(result) {
            $('#_blueprint-table').html(result.data.view);
            $('#tableExample3').DataTable({
                dom: "<'row'<'col-sm-4 col-sm-offset-8'f>>tp",
                "aaSorting": [],
                "language": {

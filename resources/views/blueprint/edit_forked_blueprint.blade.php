         ...
         <div class="container">
            <div class="row">
               <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
                  <form method="post" action="{!! route('postEditForkedBlueprint', [$forkBlueprintInfo->id]) !!}"
                              ...
                              <div class="col-xs-12 col-sm-12">
                                 <div class="form-group form-group-lg">
                                    ...
                                    <input type="text" class="form-control" name="blueprint_name"
                                           value="{!! $forkBlueprintInfo->blueprint->title !!}" disabled />
                                 </div>
                              </div>
                              <div class="col-xs-12 col-sm-12 col-md-12">
                                 <label>{{ __('CreateBlueprint.Topic') }}:</label>
                                 <select class="form-control" name="topic_id" disabled>
                                    @foreach($topics as $topic)
                                       @if($forkBlueprintInfo->topics_id == $topic->id)
                              ...
                              <div class="col-xs-12 col-sm-12">
                                 <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="15" name="blueprint_desc"
                                              required>{!! $forkBlueprintInfo->description !!}</textarea>
                                 </div>
                              </div>
                           </div>
                           <div class="mb-30"></div>
                                       ...
                                       <div class="col-xs-2 col-sm-2">
                                          <div class="form-group form-spin-group">
                                             ...
                                             <input type="text" class="form-control form-spin"
                                                    name="improve_product[{{ $improveDetail->products_id }}]"
                                                    value="{!! $improveDetail->quantity !!}"/>
                                          </div>
                                       </div>
                                       <div class="col-xs-5 col-sm-5">
                                          <div class="form-group">
                                             <label for="sel1">{{ __('Product\'s type')  }}:</label>
                                             <select class="form-control" id="sel1">
                                                <option selected>{!! $improveDetail->product->category->name !!}</option>
                                             </select>
                                          </div>
                                       </div>
                                    </div>

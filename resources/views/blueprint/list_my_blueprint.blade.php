            ...
            <div class="trip-guide-wrapper">
               <div class="GridLex-gap-20 GridLex-gap-15-mdd GridLex-gap-10-xs">
                  <div class="GridLex-grid-noGutter-equalHeight GridLex-grid-center">
                     @foreach($allUserblueprint as $blueprint)
                           ...
                           <div class="trip-guide-item">
                              ...
                              <div class="trip-guide-bottom">
                                 <div class="trip-guide-person clearfix">
                                    ...
                                    <p class="name">{{ __('By') }}: <a href="{{ route('other-profile', [$blueprint->user->id]) }}">
                                          {!! $blueprint->user->name !!}
                                       </a>
                                    </p>
                                 </div>
               ...
               <div class="pager-innner">
                  <div class="clearfix">
                     <p>{{ __('Showing blueprint ') }}
                        <b> {{ $allUserblueprint->firstItem() }} </b>
                        {{ __('to blueprint') }}
                        <b> {{ $allUserblueprint->lastItem() }} </b>
                        {{ __('of') }}
                        <b> {{ $allUserblueprint->total() }} </b>
                     </p>
                  </div>
                  <div class="clearfix">
                     {!! $allUserblueprint->links() !!}
                  </div>
               </div>
            </div>
         </div>

                     ...
                     <div class="create-tour-inner">
                        ...
                        <div class="row gap-20">
                           ...
                           <div class="checkbox-wrapper" id="blueprint-prd">
                              @foreach($blueprintInfo->details as $blueprintProduct)
                              <div class="col-xss-12 col-xs-12 col-sm-6 col-md-12" id="bueprint_product{{ $blueprintProduct->id }}">
                                 <div class="col-xs-5 col-sm-5">
                                    <div class="form-group">
                                       <label>{{ __('CreateBlueprint.Suggest.Name') }}
                                       :</label><br/>
                                       {!! $blueprintProduct->product->name !!}
                                    </div>
                                 </div>
                                 <div class="col-xs-2 col-sm-2">
                                    <div class="form-group form-spin-group">
                                       ...
                                       <input type="text" class="form-control form-spin"
                                          name="Product['ABC']"
                                          value="{!! $blueprintProduct->quantity !!}"/>
                                    </div>
                                 </div>
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-12">
                              ...
                              @if($blueprintInfo->suggests)
                              @foreach($blueprintInfo->suggests as $suggest)
                              <div class="col-xss-12 col-xs-12 col-sm-12 col-md-12" id="suggestProduct{{ $suggest->id }}">
                                 <div class="col-xs-5 col-sm-5">
                                    <div class="form-group">
                                       <label>Product's name: </label><br/> {!! $suggest->name !!}
                                    </div>
                                 </div>
                                 <div class="col-xs-2 col-sm-2">
                                    <div class="form-group form-spin-group"><label>Price</label>
                                       <input type="number" class="form-control form-spin" value="{!! $suggest->price !!}" disabled />
                                    </div>
                                 </div>
                                 <div class="col-xs-4 col-sm-4">
                                    <div class="form-group">
                                       <label for="sel1">Product's type:</label>
                                       <select class="form-control" id="sel1">
                                          <option selected>{!! $suggest->category->name !!}</option>
                                       </select>
                                    </div>
                                 </div>
                                 <div class="col-xs-1 col-sm-1">
